        ...
        <div className="w-1/3 bg-gray-50 border-r border-gray-200 p-4 flex flex-col h-full  custom-scrollbar">
            <section className="top-sec h-full">
                ...
                <div onClick={() => handleSelectedComponet("Manage-Tiffin")} className={`mb-2`}>
                    <div
                        className={`cursor-pointer py-2 px-3  rounded-md shadow-sm hover:bg-gray-100  transition-all duration-300 ease-in-out flex justify-between items-center ${selectedComponet == "Manage-Tiffin" ? "bg-gray-100" : "bg-white"}`}
                ...
                <div onClick={() => handleSelectedComponet("Instructions")} className="mb-2">
                    <div
                        className={`cursor-pointer py-2 px-3  rounded-md shadow-sm hover:bg-gray-100  transition-all duration-300 ease-in-out flex justify-between items-center ${selectedComponet == "Instructions" ? "bg-gray-100" : "bg-white"}`}
                ...
                <div onClick={() => handleSelectedComponet("Reviews")} className="mb-2">
                    <div
                        className={`cursor-pointer py-2 px-3  rounded-md shadow-sm hover:bg-gray-100  transition-all duration-300 ease-in-out flex justify-between items-center ${selectedComponet == "Reviews" ? "bg-gray-100" : "bg-white"}`}
