    ...
    <div className="container mx-auto p-6 bg-gray-50">
      <form onSubmit={handleSubmit} className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="flex justify-end">
          <button
            type="submit"
            className="px-4 py-2 text-sm bg-red-600 text-white rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition duration-150 ease-in-out flex items-center space-x-2"
          >
            <FaSave />
