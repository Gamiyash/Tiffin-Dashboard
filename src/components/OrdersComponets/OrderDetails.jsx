...
export default function OrderDetails({ order, onStatusChange }) {
    ...
    return (
        <div className="bg-white shadow-md rounded-md px-3 py-3 w-full overflow-hidden">
            ...
            <div className="mb-3">
                <div className="flex justify-between gap-4 items-center mb-">
                    ...
                    {progressSteps.map((step, index) => (
                        <div key={index} className="flex items-center">
                            <div className="flex flex-col">
                                <div
                                    className={`w-8 h-8 rounded-full flex items-center justify-center text-white font-bold ${order.status === "Delivered" && step === "Delivered" ? "bg-green-400" : order.status === step ? "bg-blue-500"
